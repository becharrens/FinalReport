...
\newcommand{\goreturn}{\kwd{return}}
\newcommand{\goswitch}{\kwd{switch}}
\newcommand{\goselect}{\kwd{select}}
\newcommand{\godefault}{\kwd{default}}
\newcommand{\gocase}{\kwd{case}}
% GO KWDS
...
\newcommand{\pkgenumaccess}[2]{\pkgname{#1}.\enumvalue{#2}}
\newcommand{\methodcall}[2]{\varname{#1}.\functionname{#2}}
\newcommand{\structaccess}[2]{\varname{#1}.\structfield{#2}}
...
\newcommand{\params}[1]{(\,#1\,)}
\newcommand{\emptyparams}{(\,)}
\newcommand{\chansend}[2]{#1\ \texttt{<-}\ #2}
% HELPER CMDS