...
\begin{figure}[h!]
    \begin{center}
        \begin{tabular}{l}
            ...
            $R_1 = R_2 \implies \mathtt{IS\_RECV\_FROM}(\,R_2,\ \contG{\messageFromL{a}{S}{R_1}}{T}\;)$\\[7pt]

            $R_1 = R_2 \implies \mathtt{IS\_RECV\_FROM}(\,R_2,\ \contG{\acceptL{D@P}{A}{B}{R_1}}{T}\;)$\\[14pt]
