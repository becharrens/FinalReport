...
\section{Projection}
As in the original paper, projecting a global or nested protocol requires having an environment which keeps track of all the protocols which are in scope. In the definition of projection below we assume that the given environment contains all the protocols which are in the scope of the protocol. We will describe a way of building such an environment later.
...
$(\rec\ t\ \{G\}) \project\ =\ \rec\ t\ \{G \project\}$\\
