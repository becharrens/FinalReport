...
\begin{itemize}
    ...
    \item Internal invitations are accepted through the \texttt{accept} construct, which contains information about the person who sent the inviation, the local protocol which the role is going to be carrying out as well as all the roles which will be participating as well.
\end{itemize}
...
\section{Protocol Projection}

The projection operation remains the same as defined in the Featherweight Scribble paper\cite{featherweight} for all constructs except the \texttt{choice} and \texttt{do}. 
